...
/**
 * GooglePlusSquare icon from Font Awesome
 * @module
 */
export function FaGooglePlusSquare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaGooglePlusSquare;

...
/**
 * RegGrinTongueWink icon from Font Awesome
 * @module
 */
export function FaRegGrinTongueWink(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegGrinTongueWink;

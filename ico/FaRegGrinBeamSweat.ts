...
/**
 * RegGrinBeamSweat icon from Font Awesome
 * @module
 */
export function FaRegGrinBeamSweat(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegGrinBeamSweat;

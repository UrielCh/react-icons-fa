...
/**
 * RegCaretSquareUp icon from Font Awesome
 * @module
 */
export function FaRegCaretSquareUp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegCaretSquareUp;

...
/**
 * RegCaretSquareDown icon from Font Awesome
 * @module
 */
export function FaRegCaretSquareDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegCaretSquareDown;

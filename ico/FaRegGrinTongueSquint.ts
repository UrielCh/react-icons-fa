...
/**
 * RegGrinTongueSquint icon from Font Awesome
 * @module
 */
export function FaRegGrinTongueSquint(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegGrinTongueSquint;

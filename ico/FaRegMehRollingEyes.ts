...
/**
 * RegMehRollingEyes icon from Font Awesome
 * @module
 */
export function FaRegMehRollingEyes(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegMehRollingEyes;

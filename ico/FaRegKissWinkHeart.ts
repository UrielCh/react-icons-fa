...
/**
 * RegKissWinkHeart icon from Font Awesome
 * @module
 */
export function FaRegKissWinkHeart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegKissWinkHeart;

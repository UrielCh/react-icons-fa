...
/**
 * HackerNewsSquare icon from Font Awesome
 * @module
 */
export function FaHackerNewsSquare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaHackerNewsSquare;

...
/**
 * RegArrowAltCircleLeft icon from Font Awesome
 * @module
 */
export function FaRegArrowAltCircleLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegArrowAltCircleLeft;

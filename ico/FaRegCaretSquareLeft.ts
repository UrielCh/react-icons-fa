...
/**
 * RegCaretSquareLeft icon from Font Awesome
 * @module
 */
export function FaRegCaretSquareLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegCaretSquareLeft;

...
/**
 * RegCaretSquareRight icon from Font Awesome
 * @module
 */
export function FaRegCaretSquareRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default FaRegCaretSquareRight;
